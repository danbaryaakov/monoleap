...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "MVSelectorScrollView/MVSelectorScrollView/scroller_bg@2x.png"
  install_resource "MVSelectorScrollView/MVSelectorScrollView/scroller_glass@2x.png"
  install_resource "MVSelectorScrollView/MVSelectorScrollView/MVSelectorScrollView.xib"
fi
