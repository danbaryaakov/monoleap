...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/MVSelectorScrollView/MVSelectorScrollView/scroller_bg@2x.png"
  install_resource "${PODS_ROOT}/MVSelectorScrollView/MVSelectorScrollView/scroller_glass@2x.png"
  install_resource "${PODS_ROOT}/MVSelectorScrollView/MVSelectorScrollView/MVSelectorScrollView.xib"
fi
