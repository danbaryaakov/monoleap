...
struct MonoleapAssets {
    ...
    static func rect(topLeftRadius: CGFloat = 0, topRightRadius: CGFloat = 0, bottomLeftRadius: CGFloat = 0, bottomRightRadius: CGFloat = 0) -> RoundedCorners {
        return RoundedCorners(tl: topLeftRadius, tr: topRightRadius, bl: bottomLeftRadius, br: bottomRightRadius)
    }
